...
return (new CustomEvent(event_name,(function (){var obj30342 = ({"detail":data});
return obj30342;
})()));
} else {
...
var f = (function (){var pred__30349 = cljs.core._EQ_;
var expr__30350 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30349.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30350))){
return (function (p1__30343_SHARP_){
return console.warn(p1__30343_SHARP_);
});
} else {
if(cljs.core.truth_(pred__30349.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30350))){
return (function (p1__30344_SHARP_){
return console.debug(p1__30344_SHARP_);
});
} else {
if(cljs.core.truth_(pred__30349.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30350))){
return (function (p1__30345_SHARP_){
return console.error(p1__30345_SHARP_);
});
} else {
return (function (p1__30346_SHARP_){
return console.log(p1__30346_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30353){
...
var eval_fn = cljs.core.get.call(null,map__30354__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__30356_SHARP_){
return new_def.callback(p1__30356_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__30357){
var vec__30358 = p__30357;
var ky = cljs.core.nth.call(null,vec__30358,(0),null);
...
}catch (e30363){if((e30363 instanceof Error)){
var e = e30363;
return not_found;
} else {
throw e30363;
...
//# sourceMappingURL=utils.js.map?rel=1627930536318
