...
var line = cljs.core.get.call(null,map__26907__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26907__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26906){var _e = e26906;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___26909 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___26909)){
var seen_errors_26910 = temp__5733__auto___26909;
if(cljs.core.truth_(seen_errors_26910.has(self))){
} else {
seen_errors_26910.add(self);

var temp__5735__auto___26911 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___26911)){
var sense_26912 = temp__5735__auto___26911;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26912)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1627930534590
