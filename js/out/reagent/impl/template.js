...
var G__25562 = o;
goog.object.set(G__25562,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25564__i < G__25564__a.length) {G__25564__a[G__25564__i] = arguments[G__25564__i + 0]; ++G__25564__i;}
  args = new cljs.core.IndexedSeq(G__25564__a,0,null);
} 
...
var G__25566 = o;
goog.object.set(G__25566,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25570 = props;
var G__25570__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25570,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25570);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25570__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__25570__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__25571 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25571,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__25571;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25572){
...
var on_write = cljs.core.get.call(null,map__25573__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__25575_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25575_SHARP_);
}));
} else {
return null;
}
...
var vec__25578 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25578,(0),null);
var id = cljs.core.nth.call(null,vec__25578,(1),null);
var className = cljs.core.nth.call(null,vec__25578,(2),null);
...
var temp__5739__auto___25582 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___25582 == null)){
} else {
var key_25583 = temp__5739__auto___25582;
(jsprops.key = key_25583);
}
...
var temp__5739__auto___25584 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___25584 == null)){
} else {
var key_25585 = temp__5739__auto___25584;
(jsprops.key = key_25585);
}
...
var temp__5739__auto___25586 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___25586 == null)){
} else {
var key_25587 = temp__5739__auto___25586;
(jsprops.key = key_25587);
}
...
var G__25589 = n;
if(cljs.core._EQ_.call(null,"",G__25589)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25590){
var G__25591 = cljs.core.first.call(null,seq25590);
var seq25590__$1 = cljs.core.next.call(null,seq25590);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25591,seq25590__$1);
}));
...
break;
default:
var G__25597 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25597;
continue;
...
var ctx = ({});
var vec__25599 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__25599,(0),null);
var derefed = cljs.core.nth.call(null,vec__25599,(1),null);
...
var G__25602 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25602) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1627930532918
