...
return cljs.core.remove.call(null,(function (p1__24914_SHARP_){
return cljs.core._EQ_.call(null,p1__24914_SHARP_,new cljs.core.Keyword(null,"crossover-padding","crossover-padding",813834141));
}),cljs.core.map.call(null,(function (p1__24915_SHARP_,p2__24916_SHARP_){
if((cljs.core.rand.call(null) < 0.5)){
return p1__24915_SHARP_;
} else {
return p2__24916_SHARP_;
}
...
return cljs.core.remove.call(null,(function (p1__24917_SHARP_){
return cljs.core._EQ_.call(null,p1__24917_SHARP_,new cljs.core.Keyword(null,"crossover-padding","crossover-padding",813834141));
}),cljs.core.map.call(null,(function (p1__24918_SHARP_,p2__24919_SHARP_){
if((cljs.core.rand.call(null) < 0.5)){
return p1__24918_SHARP_;
} else {
return p2__24919_SHARP_;
}
}),shorter_padded,longer));
});
/**
...
var length_diff = (cljs.core.count.call(null,longer) - cljs.core.count.call(null,shorter));
var shorter_padded = cljs.core.concat.call(null,shorter,cljs.core.repeat.call(null,length_diff,new cljs.core.Keyword(null,"crossover-padding","crossover-padding",813834141)));
return cljs.core.flatten.call(null,cljs.core.remove.call(null,(function (p1__24920_SHARP_){
return cljs.core._EQ_.call(null,p1__24920_SHARP_,new cljs.core.Keyword(null,"crossover-padding","crossover-padding",813834141));
}),cljs.core.map.call(null,(function (p1__24921_SHARP_,p2__24922_SHARP_){
if((cljs.core.rand.call(null) < 0.5)){
return p1__24921_SHARP_;
} else {
return p2__24922_SHARP_;
}
}),shorter_padded,longer)));
});
/**
...
var length_diff = (cljs.core.count.call(null,longer) - cljs.core.count.call(null,shorter));
var shorter_padded = cljs.core.concat.call(null,cljs.core.repeat.call(null,length_diff,new cljs.core.Keyword(null,"crossover-padding","crossover-padding",813834141)),shorter);
return cljs.core.flatten.call(null,cljs.core.remove.call(null,(function (p1__24923_SHARP_){
return cljs.core._EQ_.call(null,p1__24923_SHARP_,new cljs.core.Keyword(null,"crossover-padding","crossover-padding",813834141));
}),cljs.core.map.call(null,(function (p1__24924_SHARP_,p2__24925_SHARP_){
if((cljs.core.rand.call(null) < 0.5)){
return p1__24924_SHARP_;
} else {
return p2__24925_SHARP_;
}
}),shorter_padded,longer)));
});
/**
...
return cljs.core.apply.call(null,cljs.core.concat,cljs.core.map.call(null,(function (p1__24926_SHARP_){
if((cljs.core.rand.call(null) < umad_rate)){
return cljs.core.shuffle.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24926_SHARP_,propeller.utils.random_instruction.call(null,instructions)], null));
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__24926_SHARP_], null);
}
}),plushy));
});
/**
...
return cljs.core.map.call(null,(function (p1__24927_SHARP_){
...
return cljs.core.interleave.call(null,cljs.core.map.call(null,cljs.core.first,cljs.core.partition.call(null,(2),plushy)),cljs.core.map.call(null,(function (p1__24928_SHARP_){
if((cljs.core.rand.call(null) < replacement_rate)){
return propeller.utils.random_instruction.call(null,instructions);
} else {
...
return cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__24929_SHARP_){
if((cljs.core.rand.call(null) < flip_rate)){
return cljs.core.reverse.call(null,p1__24929_SHARP_);
} else {
return p1__24929_SHARP_;
}
}),cljs.core.partition.call(null,(2),plushy)));
});
/**
...
var vec__24933 = cljs.core.first.call(null,ops_probs);
var op1 = cljs.core.nth.call(null,vec__24933,(0),null);
var prob1 = cljs.core.nth.call(null,vec__24933,(1),null);
if(((accum + prob1) >= r)){
return op1;
} else {
var G__24937 = (accum + prob1);
var G__24938 = cljs.core.rest.call(null,ops_probs);
accum = G__24937;
ops_probs = G__24938;
continue;
}
...
//# sourceMappingURL=variation.js.map?rel=1627930531550
