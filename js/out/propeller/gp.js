 ...
 * Main GP loop.
 */
propeller.gp.gp = (function propeller$gp$gp(p__26676){
...
var argmap = map__26677__$1;
var population_size = cljs.core.get.call(null,map__26677__$1,new cljs.core.Keyword(null,"population-size","population-size",-1175003618));
var max_generations = cljs.core.get.call(null,map__26677__$1,new cljs.core.Keyword(null,"max-generations","max-generations",784506896));
var error_function = cljs.core.get.call(null,map__26677__$1,new cljs.core.Keyword(null,"error-function","error-function",-421428962));
var instructions = cljs.core.get.call(null,map__26677__$1,new cljs.core.Keyword(null,"instructions","instructions",1724333802));
var max_initial_plushy_size = cljs.core.get.call(null,map__26677__$1,new cljs.core.Keyword(null,"max-initial-plushy-size","max-initial-plushy-size",-374353728));
...
var generation = (0);
var population = cljs.core.repeatedly.call(null,population_size,((function (generation,map__26677,map__26677__$1,argmap,population_size,max_generations,error_function,instructions,max_initial_plushy_size){
return (function (){
...
});})(generation,map__26677,map__26677__$1,argmap,population_size,max_generations,error_function,instructions,max_initial_plushy_size))
);
while(true){
...
new cljs.core.Keyword(null,"custom-report","custom-report",1014027624).cljs$core$IFn$_invoke$arity$1(argmap).call(null,evaluated_pop,generation,argmap);
} else {
...
var G__26679 = (generation + (1));
var G__26680 = (cljs.core.truth_(new cljs.core.Keyword(null,"elitism","elitism",-650754994).cljs$core$IFn$_invoke$arity$1(argmap))?cljs.core.conj.call(null,cljs.core.repeatedly.call(null,(population_size - (1)),((function (generation,population,evaluated_pop,best_individual,map__26677,map__26677__$1,argmap,population_size,max_generations,error_function,instructions,max_initial_plushy_size){
return (function (){
return propeller.variation.new_individual.call(null,evaluated_pop,argmap);
});})(generation,population,evaluated_pop,best_individual,map__26677,map__26677__$1,argmap,population_size,max_generations,error_function,instructions,max_initial_plushy_size))
),cljs.core.first.call(null,evaluated_pop)):cljs.core.repeatedly.call(null,population_size,((function (generation,population,evaluated_pop,best_individual,map__26677,map__26677__$1,argmap,population_size,max_generations,error_function,instructions,max_initial_plushy_size){
return (function (){
return propeller.variation.new_individual.call(null,evaluated_pop,argmap);
});})(generation,population,evaluated_pop,best_individual,map__26677,map__26677__$1,argmap,population_size,max_generations,error_function,instructions,max_initial_plushy_size))
));
...
//# sourceMappingURL=gp.js.map?rel=1627930534140
