...
return cljs.core.nth.call(null,p1__24902_SHARP_,cljs.core.first.call(null,cases));
});})(survivors,cases))
,cljs.core.map.call(null,new cljs.core.Keyword(null,"errors","errors",-908790718),survivors)));
var G__24904 = cljs.core.filter.call(null,((function (survivors,cases,min_err_for_case){
return (function (p1__24903_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.nth.call(null,new cljs.core.Keyword(null,"errors","errors",-908790718).cljs$core$IFn$_invoke$arity$1(p1__24903_SHARP_),cljs.core.first.call(null,cases)),min_err_for_case);
});})(survivors,cases,min_err_for_case))
,survivors);
var G__24905 = cljs.core.rest.call(null,cases);
survivors = G__24904;
cases = G__24905;
continue;
}
...
var G__24906 = new cljs.core.Keyword(null,"parent-selection","parent-selection",-1130458191).cljs$core$IFn$_invoke$arity$1(argmap);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24906__$1)].join('')));

}
});

//# sourceMappingURL=selection.js.map?rel=1627930531493
