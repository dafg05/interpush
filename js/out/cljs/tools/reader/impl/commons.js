...
var G__25093 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__25093;
continue;
} else {
return ch;
...
var vec__25094 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__25094,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq25097){
...
return (function() { 
var G__25102__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__25102 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__25103__i = 0, G__25103__a = new Array(arguments.length -  1);
while (G__25103__i < G__25103__a.length) {G__25103__a[G__25103__i] = arguments[G__25103__i + 1]; ++G__25103__i;}
  _ = new cljs.core.IndexedSeq(G__25103__a,0,null);
} 
return G__25102__delegate.call(this,rdr,_);};
G__25102.cljs$lang$maxFixedArity = 1;
G__25102.cljs$lang$applyTo = (function (arglist__25104){
var rdr = cljs.core.first(arglist__25104);
var _ = cljs.core.rest(arglist__25104);
return G__25102__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1627930532075
